...
import { getMedicalImages, MedicalImage } from "@/data/medicalImages";

type Props = { images: MedicalImage[] };

export default function Medical({ images }: Props) {
  return (
    <div>
      <div className="flex flex-col md:flex-row items-center gap-6 my-8">
        ...
        <ul className="flex flex-wrap items-center gap-x-9 gap-y-3 text-xl text-[#e8e5e2] list-disc list-inside  mt-[0.5rem] p-0">
          <li className="whitespace-nowrap">MR Forms</li>
          <li className="whitespace-nowrap">Medical Record Covers</li>
          {/* examples with multi-word terms */}
          <li className="whitespace-nowrap">Custom whiteboards</li>
          <li className="whitespace-nowrap">Custom Procedure &amp; Medical Signage</li>
        </ul>
      </div>
      ...
      <div className="h-px w-full bg-[#e8e5e2] my-2" />
